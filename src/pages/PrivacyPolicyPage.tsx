  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-summi-green/5 to-summi-secondary/5">
      <SEO
        ...
        description={t('privacy_policy_subtitle')}
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6 text-sm">
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">1. Informações que coletamos</h2>
              <div className="space-y-3">
                <div>
                  <h3 className="text-sm font-medium text-summi-gray-800">1.1 Informações fornecidas diretamente</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-summi-gray-800">1.2 Informações coletadas automaticamente</h3>
                  <ul className="list-disc ml-6 mt-2 space-y-1 text-summi-gray-700">
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">2. Como usamos suas informações</h2>
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">3. Compartilhamento de informações</h2>
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">4. Segurança dos dados</h2>
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">5. Retenção de dados</h2>
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">6. Seus direitos e controles</h2>
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">7. Cookies e tecnologias similares</h2>
              <p className="text-summi-gray-700">
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">8. Alterações nesta política</h2>
              <p className="text-summi-gray-700">
            ...
            <section>
              <h2 className="text-base font-semibold text-summi-gray-900 mb-2">9. Contato</h2>
              <p className="text-summi-gray-700">
            ...
            <div className="bg-summi-green/10 p-4 rounded-lg border border-summi-green/20 mt-6">
              <h3 className="font-semibold text-summi-green mb-2">Transparência:</h3>
              <p className="text-summi-gray-700">
