...
const LandingPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
    ...
    <section className="lg:py-0 mx-0 my-0 py-[20px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-[32px]">
    ...
    <section id="como-funciona" className="bg-gray-50 py-[21px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Em apenas 3 passos simples, você terá a Summi conectada ao WhatsApp</p>
        </div>
    ...
    <section id="recursos" className="bg-white py-[32px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Além de Transcrever Audios, a Summi analisa suas conversas de WhatsApp e entrega resumos periódicos com as informações mais importantes.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="border-gray-200 hover:shadow-xl transition-all duration-300 relative">
            <CardHeader className="text-center pb-8">
              ...
              <div className="mt-6">
                <span className="text-5xl font-bold text-gray-900">R$ 47,90</span>
          ...
          <Card className="border-green-500 shadow-2xl relative bg-gradient-to-br from-white to-green-50 transform scale-105">
            ...
            <CardHeader className="text-center pb-8 pt-8">
              ...
              <div className="mt-6">
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="text-5xl font-bold text-green-600">R$ 29,90</span>
                </div>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="flex items-center text-sm text-green-700 font-medium">
                  <Check className="w-4 h-4 text-green-600 mr-3" />
                  <span><strong>37% de desconto garantido</strong></span>
                </div>
                <div className="flex items-center text-sm text-green-700 font-medium">
                  <Check className="w-4 h-4 text-green-600 mr-3" />
