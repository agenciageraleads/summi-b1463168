          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Nome</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Número</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Role</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Assinatura</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Conexão</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Instância</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Criado em</th>
                <th className="text-left py-3 px-4 font-medium text-gray-600 whitespace-nowrap">Ações</th>
              </tr>
            </thead>
            <tbody>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter') e.currentTarget.click(); }} onClick={() => handleAction(
                                  user.id,
                                  'restart',
